  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-white">
      ...
      <div className="flex flex-col items-center justify-center my-auto">
        ...
        <button onClick={loginHandler} className="m-10 flex items-center px-8 py-4 bg-gray-800 text-lg rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 mb-8">
